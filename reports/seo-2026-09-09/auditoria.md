...
4. Google Business Profile revisado: perfil verificado, dirección y teléfonos consistentes, horario lunes–viernes 7:00–16:30, categoría principal “Tienda de uniformes”, secundarias “Tienda de calzados” y “Fábrica de ropa y textiles”, 4,6/5 con 27 reseñas y solo dos productos publicados. Se enviaron para revisión una descripción coherente con Medellín–Envigado y las áreas de servicio Medellín y Envigado, conservando Antioquia. Ampliar productos con fichas vigentes y obtener reseñas auténticas de compradores sin incentivos ni guiones con palabras clave obligatorias.
...
Además del sitemap, se solicitaron en Search Console rastreos prioritarios de portada, /dotaciones-medellin/ y /contacto/. En Google Business Profile quedaron pendientes de revisión de Google la nueva descripción y las áreas Medellín y Envigado. No se reinició la validación global de 404 porque 57 retiradas definitivas deben seguir respondiendo 404. La consolidación `www` sigue pendiente en la configuración de dominios de Vercel; el usuario autenticado disponible no tiene acceso al equipo propietario. Los resultados de posicionamiento se evaluarán durante 8–12 semanas.
